...
def get_db_path() -> str:
    # On Vercel / AWS Lambda, the application bundle is read-only.
    ...
    local_path = os.path.join(os.path.dirname(os.path.dirname(os.path.abspath(__file__))), "cache.db")
    if not os.path.exists(local_path):
        same_dir_path = os.path.join(os.path.dirname(os.path.abspath(__file__)), "cache.db")
